...
{
    public class Args_Find_DomainUserLocation
    {
        ...
        public bool UserAllowDelegation { get; set; }
        public bool AllowDelegation { get { return UserAllowDelegation; } set { UserAllowDelegation = value; } }
        ...
        public StealthSource StealthSource { get; set; } = StealthSource.All;
